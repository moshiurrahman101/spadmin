    ...
    return <div className="grid place-items-center h-screen">
        <div className="shadow-lg p-5 rounded-lg border-t-4 border-blue-600">
            ...
            <form className="flex flex-col gap-3">
                ...
                <button className="bg-blue-600 text-white py-2 rounded-sm font-bold">Login</button>
            </form>
            <div className=" mt-3 text-right">
                <Link href={"/register"} className="text-sm font-bold">
                    Dont's Have an Account? <span className="underline">Register</span>
                </Link>
            </div>
            <hr />
            {/* Social Login */}
            <div className="mt-5">
                <p className="text-gray-500 font-semibold">With login</p>
